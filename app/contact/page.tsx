              ...
              <div>
                ...
                <ul className="space-y-4 text-sm text-gray-600">
                  <li className="flex items-start gap-3">
                    ...
                    <div><p className="font-medium text-gray-800">Email</p><a href="mailto:hello@linuxjump.com" className="hover:text-indigo-600">hello@linuxjump.com</a></div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-9 h-9 rounded-lg bg-indigo-50 text-indigo-600 flex items-center justify-center shrink-0">
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-5 gap-12">
            ...
            <div className="md:col-span-2 space-y-6">
              ...
              <div className="bg-gray-50 rounded-xl border border-gray-200 p-5 text-sm">
                ...
                <p className="text-gray-400 text-xs mt-1">Urgent? Email <a href="mailto:hello@linuxjump.com" className="text-indigo-600 hover:underline">hello@linuxjump.com</a></p>
              </div>
            </div>
          </div>
        </section>
